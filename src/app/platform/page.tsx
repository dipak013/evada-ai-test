...
function PlatformHeroVisual() {
  return (
    <div className="platform-hero-visual platform-workflow-visual relative mx-auto aspect-[1.35/1] w-full max-w-[820px] overflow-visible lg:mt-5 xl:mt-6" aria-hidden="true">
